...
class EolDiscussionCheckXBlock(XBlock):
    """
    ...
    def student_view(self, context=None):
        """
        The primary view of the EolDiscussionCheckXBlock, shown to students
        when viewing courses.
        """
        html = self.resource_string("static/html/eoldiscussionscheck.html")
    ...
    def workbench_scenarios():
        ...
        return [
            ("EolDiscussionCheckXBlock",
             """<eoldiscussionscheck/>
             """),
            ("Multiple EolDiscussionCheckXBlock",
             """<vertical_demo>
                <eoldiscussionscheck/>
                <eoldiscussionscheck/>
                <eoldiscussionscheck/>
